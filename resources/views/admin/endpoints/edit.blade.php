        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <x-alerts />
                    <form
                        action="{{ route('endpoints.update', [$site->id, $endpoint->id]) }}"
                        method="post"
                    >
                        @method('PUT')
                        ...
                        <div class="flex flex-row gap-2 items-center mt-1">
                            ...
                            <a
                                ...
                                class="focus:outline-none text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mt-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-900 h-full"
                            > Voltar </a>
                        </div>
                    </form>
                </div>
